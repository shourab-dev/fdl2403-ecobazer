        ...
        <div class="grid columns-12 gap-6">
            ...
            <div class="g-col-12 mt-8">
                <div class="intro-y d-flex align-items-center h-10">
                    ...
                    <a href="index.html" class="ms-auto d-flex align-items-center text-theme-1 dark-text-theme-10"> <i
                ...
                <div class="intro-y box p-5 mt-12 mt-sm-5">
                    <div class="d-flex flex-column flex-xl-row align-items-xl-center">
                        ...
                        <div class="dropdown ms-xl-auto mt-5 mt-xl-0">
                            <button class="dropdown-toggle btn btn-outline-secondary fw-normal" aria-expanded="false"
                                data-bs-toggle="dropdown"> Filter by Category <i data-feather="chevron-down"
                                    class="w-4 h-4 ms-2"></i> </button>
                ...
                <div class="intro-y box p-5 mt-5">
                    ...
                    <div class="mt-8">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="h-px flex-1 border border-start border-dashed border-gray-300 mx-3 d-xl-none">
                            </div>
                ...
                <div class="intro-y box p-5 mt-5">
                    ...
                    <div class="mt-8">
                        <div class="d-flex align-items-center">
                            <div class="w-2 h-2 bg-theme-11 rounded-circle me-3"></div>
                            <span class="truncate">17 - 30 Years old</span>
                            <div class="h-px flex-1 border border-right border-dashed border-gray-300 mx-3 d-xl-none">
                            </div>
                            <span class="fw-medium ms-xl-auto">62%</span>
                        </div>
                        <div class="d-flex align-items-center mt-4">
            ...
            <div class="g-col-12 g-col-xl-8 mt-6">
                <div class="intro-y d-block d-sm-flex align-items-center h-10">
                    ...
                    <div class="ms-sm-auto mt-3 mt-sm-0 position-relative text-gray-700 dark-text-gray-300">
                        <i data-feather="map-pin"
                            class="w-4 h-4 z-10 position-absolute my-auto top-0 bottom-0 ms-3 start-0"></i>
                        <input type="text" class="form-control w-sm-40 box border-white dark-border-dark-3 ps-10"
                ...
                <div class="intro-y box p-5 mt-12 mt-sm-5">
                    ...
                    <div class="report-maps mt-5 bg-gray-200 rounded-3" data-center="-6.2425342, 106.8626478"
                ...
                <div class="intro-y d-block d-sm-flex align-items-center h-10">
                    ...
                    <div class="d-flex align-items-center ms-sm-auto mt-3 mt-sm-0">
                        <button class="btn box d-flex align-items-center text-gray-700 dark-text-gray-300">
                            ...
                            to Excel </button>
                        <button class="ms-3 btn box d-flex align-items-center text-gray-700 dark-text-gray-300">
                            <i data-feather="file-text" class="d-none d-sm-block w-4 h-4 me-2"></i> Export
                            to PDF </button>
                    </div>
                </div>
                    ...
                    <table class="table table-report mt-sm-2">
                        ...
                        <tbody>
                            <tr class="intro-x">
                                ...
                                <td class="w-40">
                                    <div class="d-flex align-items-center justify-content-center text-theme-6">
                            ...
                            <tr class="intro-x">
                                ...
                                <td class="w-40">
                                    <div class="d-flex align-items-center justify-content-center text-theme-9">
                        ...
                        <div class="intro-x box">
                            <div class="p-5">
                                ...
                                <div class="grid columns-7 gap-4 mt-5 text-center">
                                    ...
                                    <div class="py-0.5 bg-theme-18 dark-bg-theme-9 rounded position-relative">
                                        6</div>
                                    <div class="py-0.5 rounded position-relative">7</div>
                                    <div class="py-0.5 bg-theme-1 dark-bg-theme-1 text-white rounded position-relative">
                                        8</div>
                                    ...
                                    <div class="py-0.5 bg-theme-17 dark-bg-theme-11 rounded position-relative">
                                        23</div>
                                    ...
                                    <div class="py-0.5 bg-theme-14 dark-bg-theme-12 rounded position-relative">
                                        27</div>
